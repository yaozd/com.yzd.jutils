...
import com.yzd.jutils.toolHeaven.util.lang.reflect.ClassGenericUtil;
...
public final class ArrayUtil {
     ...
     * @since 0.1.18
     */
    public static com.yzd.jutils.toolHeaven.util.util.Optional<Object> firstNotNullElem(Object[] objects) {
        if (ArrayUtil.isEmpty(objects)) {
