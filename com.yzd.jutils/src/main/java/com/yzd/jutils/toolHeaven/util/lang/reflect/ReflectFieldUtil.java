...
public final class ReflectFieldUtil {
    ...
    public static boolean isAssignable(final Field sourceField, final Field targetField) {
        ...
        if (sourceType.isPrimitive()) {
            resolvedPrimitive = com.yzd.jutils.toolHeaven.util.lang.reflect.PrimitiveUtil.getPrimitiveType(targetType);
    ...
    public static boolean containsAnnotationField(final Class clazz,
        ...
        List<Field> fieldList = com.yzd.jutils.toolHeaven.util.lang.reflect.ClassUtil.getAllFieldList(clazz);
    ...
    public static Class getComponentType(final Field field,
        ...
        // 数组
        if (com.yzd.jutils.toolHeaven.util.lang.reflect.ClassTypeUtil.isArray(fieldType)) {
            return fieldType.getComponentType();
        }

        // 集合
        if (com.yzd.jutils.toolHeaven.util.lang.reflect.ClassTypeUtil.isCollection(fieldType)) {
