...
import com.yzd.jutils.toolHeaven.support.condition.ICondition;
import com.yzd.jutils.toolHeaven.support.filler.IFiller;
import com.yzd.jutils.toolHeaven.support.filter.IFilter;
...
public final class CollectionUtil {
    ...
    public static List<String> arrayToList(String[] array) {
        if (com.yzd.jutils.toolHeaven.util.util.ArrayUtil.isEmpty(array)) {
    ...
    public static <T, R> List<R> buildCollection(final T[] targets, final IHandler<T, R> handler) {
        if (com.yzd.jutils.toolHeaven.util.util.ArrayUtil.isEmpty(targets)) {
            return Collections.emptyList();
        }
     ...
     * @since 0.1.6
     */
    public static <T> com.yzd.jutils.toolHeaven.util.util.Optional<T> firstNotNullElem(Collection<T> list) {
        if (CollectionUtil.isEmpty(list)) {
            return com.yzd.jutils.toolHeaven.util.util.Optional.empty();
        }

        for (T elem : list) {
            if (ObjectUtil.isNotNull(elem)) {
                return com.yzd.jutils.toolHeaven.util.util.Optional.of(elem);
            }
        }
