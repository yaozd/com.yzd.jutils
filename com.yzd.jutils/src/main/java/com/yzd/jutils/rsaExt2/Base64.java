...
public class Base64 {
    ...
    public Object decode(Object pObject) {
        if (!(pObject instanceof byte[])) {
            throw new IllegalStateException("Parameter supplied to Base64 decode is not a byte[]");
        }
    ...
    public Object encode(Object pObject) {
        if (!(pObject instanceof byte[])) {
            throw new IllegalStateException("Parameter supplied to Base64 encode is not a byte[]");
        }
