...
public final class GitInfo {
     ...
     * The Runtime Version.
     */
    public static final GitInfo RUNTIME_VERSION = GitInfo.create(GitInfo.class.getResourceAsStream("/git.properties"));

    private GitInfo(String buildId, String buildVersion, String majorVersion, String revision) {
    ...
    public static GitInfo create(InputStream is) {
